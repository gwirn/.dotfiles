...
# A better PS1
PS1='\r╭[\[\e[38;5;66m\]\u\[\e[0m\]@\[\e[1;2m\]\h\[\e[0m\]]\[\e[38;5;32;3m\]$(base=${VIRTUAL_ENV##*/}; echo "${base//[![:alnum:]]}")\[\e[0m\] \[\e[38;5;172;2m\]\w\[\e[0m\] \[\e[38;5;22m\]\[\e[0m\]\[\e[38;5;196;2m\]$(rv="$?"; if [ "$rv" -ne 0 ];then echo "[${rv}]"; fi)\[\e[0m\]\n╰\[\e[0;38;5;178;1m\]»\[\e[0m\] '
